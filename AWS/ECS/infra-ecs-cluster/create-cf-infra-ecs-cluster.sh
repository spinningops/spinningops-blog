...
# Update CF Stack
aws cloudformation create-stack --stack-name infra-ecs-cluster --template-url https://s3.amazonaws.com/cf-templates-15pal9ojx6340-us-east-1/infra-ecs-cluster.yaml \
    --parameters \
